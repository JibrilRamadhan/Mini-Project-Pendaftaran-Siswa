      ...
      <div class="p-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              >
                ...
                <option v-for="hari in hariList" :key="hari" :value="hari" class="text-gray-900 dark:text-gray-100">
                  {{ hari }}
                </option>
              </select>
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <select
                ...
                :class="[
                  readonly ? 'cursor-not-allowed opacity-75' : 'hover:border-violet-300',
                  errors.id_mapel ? 'border-red-500 focus:ring-red-500' : ''
                ]"
              >
                <option disabled value="" class="text-gray-400">Pilih Mata Pelajaran</option>
                <option v-for="(mapel, index) in mapelList" :value="index + 1" :key="index" class="text-gray-900 dark:text-gray-100">
                  {{ mapel }}
                </option>
              </select>
              <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              >
                ...
                <option v-for="(guru, index) in guruList" :value="index + 1" :key="index" class="text-gray-900 dark:text-gray-100">
                  {{ guru }}
                </option>
              </select>
              <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              <select
                ...
                :class="[
                  readonly ? 'cursor-not-allowed opacity-75' : 'hover:border-violet-300',
                  errors.id_kelas ? 'border-red-500 focus:ring-red-500' : ''
                ]"
              >
                <option disabled value="" class="text-gray-400">Pilih Kelas</option>
                <option v-for="(kelas, index) in kelasList" :value="index + 1" :key="index" class="text-gray-900 dark:text-gray-100">
                  {{ kelas }}
                </option>
              </select>
              <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
          ...
          <div class="lg:col-span-2">
            <div class="bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-900/20 dark:to-purple-900/20 rounded-2xl p-6 border border-violet-200/50 dark:border-violet-700/50">
              <div class="flex items-start space-x-4">
                <div class="w-10 h-10 bg-violet-100 dark:bg-violet-800/50 rounded-full flex items-center justify-center flex-shrink-0">
                  <i class="ri-information-line text-violet-600 dark:text-violet-400"></i>
                </div>
                <div>
                  <h4 class="font-semibold text-violet-800 dark:text-violet-200 mb-2">Tips Penjadwalan</h4>
