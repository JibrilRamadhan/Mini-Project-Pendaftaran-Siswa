        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                <i
                  v-if="form.kelas_id && !errors.kelas_id && !readonly"
                  class="ri-check-line text-green-500 mr-2"
                ></i>
                <i
                  v-if="errors.kelas_id && !readonly"
                  class="ri-error-warning-line text-red-500 mr-2"
                ></i>
                <i class="ri-arrow-down-s-line text-gray-400"></i>
              </div>
            </div>
