<template>
  <div
    class="min-h-screen bg-gradient-to-br from-slate-50 via-violet-50 to-purple-100 dark:from-gray-900 dark:via-slate-900 dark:to-violet-950 p-6"
  >
    <div class="max-w-7xl mx-auto">
      ...
      >
        <div class="flex justify-between items-center">
          <div class="space-y-2">
            <h1
              class="text-4xl font-bold bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent"
            >
              Data Kelas
            </h1>
            <p class="text-gray-600 dark:text-gray-400 text-lg">
              Kelola ruang belajar dan kapasitas kelas dengan efektif
            </p>
          </div>
          ...
          >
            <div
              class="absolute inset-0 bg-gradient-to-r from-violet-400 to-purple-400 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-300"
            ></div>
      ...
      >
        ...
        <div
          class="bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 p-6 flex justify-between items-center"
        >
        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            <thead>
              ...
              >
                <th
                  class="px-6 py-4 text-left text-sm font-bold text-gray-700 dark:text-gray-200 uppercase tracking-wider border-b-2 border-violet-200 dark:border-violet-800"
                >
              ...
              >
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-8 h-8 text-black rounded-full flex items-center justify-center dark:text-white font-bold text-lg"
                    >
                      {{ index + 1 }}
                    </div>
                  </div>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-12 h-12 bg-gradient-to-r from-violet-400 to-purple-500 rounded-2xl flex items-center justify-center text-white font-bold mr-4 relative overflow-hidden"
                    >
                      <div
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div
                    class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-violet-100 to-purple-100 text-violet-800 dark:from-violet-900 dark:to-purple-900 dark:text-violet-200 border border-violet-200 dark:border-violet-700"
                  >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-10 h-10 bg-gradient-to-r from-indigo-400 to-violet-500 rounded-full flex items-center justify-center mr-3"
                    >
        ...
        <div v-if="filteredKelas.length === 0" class="text-center py-16">
          <div
            class="w-32 h-32 mx-auto mb-6 bg-gradient-to-r from-violet-100 to-purple-200 dark:from-violet-700 dark:to-purple-800 rounded-full flex items-center justify-center"
          >
          ...
          <button
            @click="tambahBaru"
            class="px-6 py-3 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all duration-300"
          >
        ...
        >
          ...
          >
            <div class="flex items-center space-x-3">
              <div
                class="w-12 h-12 bg-gradient-to-r from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center text-white font-bold relative overflow-hidden"
              >
...
function getGuruById(id) {
  const guru = guruList.value.find((g) => Number(g.id_guru) === Number(id))
  return guru ? `${guru.nama_guru} (${guru.nip})` : 'Belum Ditentukan'
}
