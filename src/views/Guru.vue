...
const deleteConfirmAlert = async (itemName = 'item', options = {}) => {
  const theme = getThemeConfig()
...
async function KonfirmasiHapus() {
  ...
  if (!item?.id_guru) return

  const hasil = await deleteConfirmAlert(item.nama_guru)

  if (hasil.isConfirmed) {
    hapusItem(item.id_guru) // Perbaikan: kirim id_guru bukan object
    await successAlert('Terhapus!', `Guru "${item.nama_guru}" berhasil dihapus.`)
    clearSelected()
  }
}
...
<template>1
  <div
    class="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-teal-100 dark:from-gray-900 dark:via-slate-900 dark:to-emerald-950 p-6"
  >
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center">
          <div class="space-y-2">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-lg">
              Kelola informasi tenaga pendidik dengan mudah dan efisien
            </p>
          </div>
      ...
      >
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center gap-4">
                    <div
                      class="w-10 h-10 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full flex items-center justify-center text-white font-bold"
                    >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  >
                    <i
                      :class="item.jenis_kelamin === 'Laki-laki' ? 'ri-men-line' : 'ri-women-line'"
                      class="mr-1"
                    ></i>
                    {{ item.jenis_kelamin }}
                  </span>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-10 h-10 bg-gradient-to-r from-teal-400 to-emerald-500 rounded-full flex items-center justify-center mr-3"
                    >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div
                      class="w-10 h-10 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center mr-3"
                    >
        ...
        <div v-if="filteredData.length === 0" class="text-center py-16">
          <div
            class="w-32 h-32 mx-auto mb-6 bg-gradient-to-r from-emerald-100 to-teal-200 dark:from-emerald-700 dark:to-teal-800 rounded-full flex items-center justify-center"
          >
